...
template<class graph_type>
class Graph_SearchIDDFS : Graph_SearchDFS
{
private:
    int level = 0;
    bool Search();
...
public:
    ...
    Graph_SearchIDDFS(const graph_type& graph,
        int          source,
        int          target = -1) :
...
template <class graph_type>
bool Graph_SearchIDDFS<graph_type>::Search()
{
    //create a std stack of edges
    std::stack<const Edge*> stack;
...
//-----------------------------------------------------------------------------
template <class graph_type>
std::list<int> Graph_SearchIDDFS<graph_type>::GetPathToTarget()const
{
    std::list<int> path;
