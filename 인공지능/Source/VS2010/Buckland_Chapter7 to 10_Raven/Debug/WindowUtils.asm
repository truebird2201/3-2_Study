; Listing generated by Microsoft (R) Optimizing Compiler Version 19.32.31329.0 
	...
	TITLE	C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\WindowUtils.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG156989 DB	'Error', 00H
	ORG $+2
$SG156993 DB	'Error', 00H
	ORG $+2
$SG157092 DB	'*.*', 00H
$SG157093 DB	'All Files (*.*)', 00H
$SG157094 DB	'*.', 00H
	ORG $+1
$SG162188 DB	'invalid argument', 00H
	ORG $+3
$SG162189 DB	'%s', 00H
	ORG $+1
$SG162190 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.32.31326\include\xmemory', 00H
	ORG $+2
$SG162192 DB	00H, 00H
	ORG $+2
$SG162191 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG162193 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:?CheckBufferLength@@YA_NPADHAAH@Z
	DD	01dH
	DD	084H
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:?GetWindowWidth@@YAHPAUHWND__@@@Z
	DD	028H
	DD	064H
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:?GetWindowHeight@@YAHPAUHWND__@@@Z
	DD	028H
	DD	064H
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:?ResizeWindow@@YAXPAUHWND__@@HH@Z
	DD	02fH
	DD	0107H
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:__unwindfunclet$?FileInitialize@@YAXPAUHWND__@@AAUtagOFNA@@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@2@Z$0
	DD	068H
	DD	075H
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:?FileInitialize@@YAXPAUHWND__@@AAUtagOFNA@@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@2@Z
	DD	031H
	DD	0378H
voltbl	ENDS
xdata$x	SEGMENT
...
$LN7@Allocate_m:
	push	OFFSET $SG162188
	push	OFFSET $SG162189
	push	0
	push	135					; 00000087H
	push	OFFSET $SG162190
	push	2
	call	__CrtDbgReport
	add	esp, 24					; 00000018H
	cmp	eax, 1
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG162191
	push	OFFSET $SG162192
	push	OFFSET $SG162193
...
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.32.31326\include\iomanip
...
; 405  :     const _Smanip<_Arg>& _Manip) { // insert by calling function with output stream and argument

	push	ebp
	mov	ebp, esp
	push	esi

; 406  :     (*_Manip._Pfun)(_Ostr, _Manip._Manarg);
...
; 192  :     basic_ostream& __CLR_OR_THIS_CALL operator<<(ios_base&(__cdecl* _Pfn)(ios_base&) ) { // call ios_base manipulator
...
; 4766 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const basic_string<_Elem, _Traits, _Alloc>& _Right) {
...
; 4767 :     return _STD move(_Left.append(_Right));
...
; 4797 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, _In_z_ const _Elem* const _Right) {
...
; 4798 :     return _STD move(_Left.append(_Right));
...
; 4803 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const _Elem _Right) {
...
; 4749 :     const basic_string<_Elem, _Traits, _Alloc>& _Left, const _Elem _Right) {
...
; 4750 :     const auto _Left_size = _Left.size();

	mov	ecx, DWORD PTR __Left$[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	mov	DWORD PTR __Left_size$[ebp], eax

; 4751 :     if (_Left_size == _Left.max_size()) {
...
; 4753 :     }
; 4754 : 
; 4755 :     return {_String_constructor_concat_tag{}, _Left, _Left.c_str(), _Left_size, _STD addressof(_Right), 1};
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Common\misc\Stream_Utility_Functions.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Common\misc\WindowUtils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 199  : inline ios_base& __CLRCALL_OR_CDECL fixed(ios_base& _Iosbase) { // set floatfield to fixed

	push	ebp
	mov	ebp, esp

; 200  :     _Iosbase.setf(ios_base::fixed, ios_base::floatfield);
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	OFFSET $SG157093
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG157094
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 3925 :     _NODISCARD _CONSTEXPR20 size_type length() const noexcept {
...
; 3926 :         return _Mypair._Myval2._Mysize;
...
; 3819 :     _NODISCARD _CONSTEXPR20 reference at(const size_type _Off) {
...
; 3820 :         _Mypair._Myval2._Check_offset_exclusive(_Off);
...
; 3821 :         return _Mypair._Myval2._Myptr()[_Off];
