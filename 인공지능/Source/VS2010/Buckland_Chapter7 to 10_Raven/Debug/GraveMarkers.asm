; Listing generated by Microsoft (R) Optimizing Compiler Version 19.32.31329.0 
	...
	TITLE	C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\GraveMarkers.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG165295 DB	'invalid argument', 00H
	ORG $+3
$SG165296 DB	'%s', 00H
	ORG $+1
$SG165297 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.32.31326\include\xmemory', 00H
	ORG $+2
$SG165299 DB	00H, 00H
	ORG $+2
$SG165298 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG165300 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN7@Allocate_m:
	push	OFFSET $SG165295
	push	OFFSET $SG165296
	push	0
	push	135					; 00000087H
	push	OFFSET $SG165297
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG165298
	push	OFFSET $SG165299
	push	OFFSET $SG165300
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Buckland_Chapter7 to 10_Raven\GraveMarkers.cpp
_TEXT	SEGMENT
$T1 = -28						; size = 24
_this$ = -4						; size = 4
_pos$ = 8						; size = 16
...
; 404  :     _CONSTEXPR20 void _Take_contents(_Vector_val& _Right) noexcept {
...
; 405  :         this->_Swap_proxy_and_iterators(_Right);
...
; 409  : 
; 410  :         _Right._Myfirst = nullptr;

	mov	ecx, DWORD PTR __Right$[ebp]
	mov	DWORD PTR [ecx+4], 0

; 411  :         _Right._Mylast  = nullptr;

	mov	edx, DWORD PTR __Right$[ebp]
	mov	DWORD PTR [edx+8], 0

; 412  :         _Right._Myend   = nullptr;
...
; 896  :     _CONSTEXPR20 void push_back(const _Ty& _Val) { // insert element at end, provide strong guarantee
...
; 760  :         _Choose_pocma_v<_Alty> != _Pocma_values::_No_propagate_allocators) {
...
; 761  :         if (this == _STD addressof(_Right)) {
...
; 763  :         }
; 764  : 
; 765  :         _Alty& _Al                = _Getal();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Getal@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@AAEAAV?$allocator@UVector2D@@@2@XZ ; std::vector<Vector2D,std::allocator<Vector2D> >::_Getal
	mov	DWORD PTR __Al$[ebp], eax

; 766  :         _Alty& _Right_al          = _Right._Getal();

	mov	ecx, DWORD PTR __Right$[ebp]
	call	?_Getal@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@AAEAAV?$allocator@UVector2D@@@2@XZ ; std::vector<Vector2D,std::allocator<Vector2D> >::_Getal
	mov	DWORD PTR __Right_al$[ebp], eax

; 767  :         constexpr auto _Pocma_val = _Choose_pocma_v<_Alty>;

	mov	DWORD PTR __Pocma_val$[ebp], 0

; 768  :         if constexpr (_Pocma_val == _Pocma_values::_No_propagate_allocators) {
; 769  :             if (_Al != _Right_al) {
; 770  :                 _Move_assign_unequal_alloc(_Right);
; 771  :                 return *this;
; 772  :             }
; 773  :         }
; 774  : 
...
; 776  : #if _ITERATOR_DEBUG_LEVEL != 0
; 777  :         if constexpr (_Pocma_val == _Pocma_values::_Propagate_allocators) {
; 778  :             if (_Al != _Right_al) {
; 779  :                 // intentionally slams into noexcept on OOM, TRANSITION, VSO-466800
; 780  :                 _Mypair._Myval2._Reload_proxy(_GET_PROXY_ALLOCATOR(_Alty, _Al), _GET_PROXY_ALLOCATOR(_Alty, _Right_al));
; 781  :             }
; 782  :         }
; 783  : #endif // _ITERATOR_DEBUG_LEVEL != 0
; 784  : 
; 785  :         _Pocma(_Al, _Right_al);
...
; 786  :         _Mypair._Myval2._Take_contents(_Right._Mypair._Myval2);
...
; 724  :             _STD exchange(_Right._Mypair._Myval2._Myend, nullptr)) {
...
; 721  :         : _Mypair(_One_then_variadic_args_t{}, _STD move(_Right._Getal()),
...
; 725  :         _Mypair._Myval2._Alloc_proxy(_GET_PROXY_ALLOCATOR(_Alty, _Getal()));
...
; 726  :         _Mypair._Myval2._Swap_proxy_and_iterators(_Right._Mypair._Myval2);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Buckland_Chapter7 to 10_Raven\GraveMarkers.h
