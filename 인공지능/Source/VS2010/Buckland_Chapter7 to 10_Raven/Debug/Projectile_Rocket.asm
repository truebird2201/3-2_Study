; Listing generated by Microsoft (R) Optimizing Compiler Version 19.32.31329.0 
	...
	TITLE	C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\Projectile_Rocket.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG172121 DB	'Rocket_MaxForce', 00H
$SG172122 DB	'Rocket_Mass', 00H
$SG172123 DB	'Rocket_MaxSpeed', 00H
$SG172124 DB	'Rocket_Scale', 00H
	ORG $+3
$SG172125 DB	'Rocket_Damage', 00H
	ORG $+2
$SG172126 DB	'Rocket_BlastRadius', 00H
	ORG $+1
$SG172127 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
	...
	DB	00H, 'a', 00H, 'v', 00H, 'e', 00H, 'n', 00H, '\', 00H, 'a', 00H
	DB	'r', 00H, 'm', 00H, 'o', 00H, 'r', 00H, 'y', 00H, '\', 00H, 'P'
	DB	00H, 'r', 00H, 'o', 00H, 'j', 00H, 'e', 00H, 'c', 00H, 't', 00H
	DB	'i', 00H, 'l', 00H, 'e', 00H, '_', 00H, 'R', 00H, 'o', 00H, 'c'
	DB	00H, 'k', 00H, 'e', 00H, 't', 00H, '.', 00H, 'c', 00H, 'p', 00H
	DB	'p', 00H, 00H, 00H
$SG172128 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
	DB	' ', 00H, '!', 00H, '=', 00H, ' ', 00H, 'V', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'o', 00H, 'r', 00H, '2', 00H, 'D', 00H, '(', 00H
	DB	')', 00H, 00H, 00H
	ORG $+2
$SG172142 DB	'Rocket_ExplosionDecayRate', 00H
	ORG $+2
$SG181604 DB	'invalid argument', 00H
	ORG $+3
$SG181605 DB	'%s', 00H
	ORG $+1
$SG181608 DB	00H, 00H
	ORG $+2
$SG181606 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG181607 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H, 00H
$SG181609 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+6
$SG181756 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:__unwindfunclet$??0Rocket@@QAE@PAVRaven_Bot@@UVector2D@@@Z$0
	DD	016H
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:__unwindfunclet$?InflictDamageOnBotsWithinBlastRadius@Rocket@@AAEXXZ$0
	DD	016H
voltbl	ENDS
xdata$x	SEGMENT
...
$LN7@Allocate_m:
	push	OFFSET $SG181604
	push	OFFSET $SG181605
	push	0
	push	135					; 00000087H
	push	OFFSET $SG181606
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	135					; 00000087H
	push	OFFSET $SG181607
	push	OFFSET $SG181608
	push	OFFSET $SG181609
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\lsy01\OneDrive\바탕 화면\3-2_Study\인공지능\Source\VS2010\Buckland_Chapter7 to 10_Raven\armory\Projectile_Rocket.cpp
_TEXT	SEGMENT
tv203 = -44						; size = 8
$T1 = -36						; size = 16
$T2 = -20						; size = 16
...
; 21   :                          shooter->Pos(),
; 22   :                          shooter->Facing(),
; 23   :                          script->GetInt("Rocket_Damage"),
; 24   :                          script->GetDouble("Rocket_Scale"),
; 25   :                          script->GetDouble("Rocket_MaxSpeed"),
; 26   :                          script->GetDouble("Rocket_Mass"),
; 27   :                          script->GetDouble("Rocket_MaxForce")),
; 28   : 
; 29   :        m_dCurrentBlastRadius(0.0),
...
; 32   :    assert (target != Vector2D());
	...
	push	32					; 00000020H
	push	OFFSET $SG172127
	push	OFFSET $SG172128
	call	__wassert
	add	esp, 12					; 0000000cH
$LN3@Rocket:
...
; 116  :     if (Vec2DDistanceSq(Pos(), m_vTarget) < tolerance*tolerance)
	...
	comisd	xmm0, QWORD PTR tv337[ebp]
	jbe	SHORT $LN4@TestForImp
...
; 135  :     if (Vec2DDistance(Pos(), (*curBot)->Pos()) < m_dBlastRadius + (*curBot)->BRadius())
	...
	addsd	xmm0, QWORD PTR [edx+224]
	movsd	xmm1, QWORD PTR tv219[ebp]
	comisd	xmm0, xmm1
	jbe	SHORT $LN5@InflictDam
