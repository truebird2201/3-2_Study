		...
		case WM_KEYUP:
			switch (wParam)
			{
				...
				case VK_F2:
					...
					m_pScene->m_ppShaders[2]->m_ppObjects[0]->fly = false;
					m_pScene->m_ppShaders[2]->m_ppObjects[0]->SetPosition(XMFLOAT3({ 409.692932,115.111160,107.538094 }));
					m_pScene->m_ppShaders[2]->m_ppObjects[0]->Rotate(0.0f, 0.0f, 0.0f);
					m_pScene->m_ppShaders[2]->m_ppObjects[0]->PrepareAnimate();
					m_pScene->m_ppShaders[2]->m_ppObjects[0]->state = 0;
					break;
				case VK_F3:							// 시점 변경
...
void CGameFramework::BuildObjects()
{
	...
	pAirplanePlayer->SetPosition(XMFLOAT3({ 439.829132,115.111160,396.016663 }));
	pAirplanePlayer->Rotate(00.0f, -90.0f, 0.0f);
	pAirplanePlayer->m_AABB.Extents = { 6.2 * 3.5f,6.2 * 3.5f,14.2 * 3.5f };
