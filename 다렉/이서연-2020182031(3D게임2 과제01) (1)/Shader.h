...
public:
	...
	virtual void ReleaseShaderVariables() { if (m_pd3dCbvSrvDescriptorHeap) m_pd3dCbvSrvDescriptorHeap->Release(); }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CLineObjectsShader : public CObjectsShader
{
public:
	CLineObjectsShader();
	virtual ~CLineObjectsShader();
	virtual D3D12_DEPTH_STENCIL_DESC CreateDepthStencilState();
	virtual D3D12_SHADER_BYTECODE CreatePixelShader();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CCubeObjectsShader : public CTexturedShader
{
public:
	CCubeObjectsShader();
	virtual ~CCubeObjectsShader();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
class CDynamicCubeMappingShader : public CCubeObjectsShader
{
public:
